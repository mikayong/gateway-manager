...
<div class="flex w-screen h-screen">
	<div class=" flex-shrink-0 w-[300px] h-full flex flex-col">
		<a
			href="/app"
			class="flex items-center w-full p-3 space-x-3 text-white shadow-md  group"
		>
			<div
				class="flex items-center justify-center w-12 h-12 text-center text-white rounded-md"
			>
				{$configStore.icon}
			</div>
						...
						<div class="flex flex-col space-y-1">
							...
							>
								<div class="flex items-center justify-between w-full">
									<div class="text-slate-100 flex items-center justify-start space-x-3">
